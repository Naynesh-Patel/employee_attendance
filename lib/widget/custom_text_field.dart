    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            ...
            borderSide: const BorderSide(color: Color(0xff83B6FE), width: 0.0),
          ),
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: Color(0xff83B6FE), width: 1),
          ),
          // labelText: labelText,
          contentPadding:
          ...
          counterText: "",
          labelStyle: const TextStyle(color: Color(0xff83B6FE), fontSize: 12),
          labelText: labelText),
