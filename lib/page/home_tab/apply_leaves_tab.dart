            ...
            children: [
                ...
                child: DropdownButtonFormField<String>(
                  items: const [
                    ...
                    DropdownMenuItem(
                      value: "Casual Leave",
                      child:
                          Text("Casual Leave", style: TextStyle(fontSize: 12,fontWeight: FontWeight.w400)),
                    )
                  ],
              ...
              InkWell(
                onTap: () async {
                  ...
                  leavesController.formatSDate.text = DateFormat("MMM dd, yyyy").format(date!);
                  setState(() {});
                },
                child: Container(
                  decoration: BoxDecoration(
              ...
              InkWell(
                onTap: () async {
                  ...
                  leavesController.formatEDate.text = DateFormat("MMM dd, yyyy").format(date!);
                  setState(() {});
                },
                child: Container(
                  decoration: BoxDecoration(
                ...
                return SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(height: 5,
                        width: 100,
                        decoration: BoxDecoration(color: Color(0xffE7E7E8),
                            borderRadius: BorderRadius.circular(10)
                        ),
                      ),
                      Lottie.asset('assets/json/done_ani.json',height: 200),
