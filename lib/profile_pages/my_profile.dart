      ...
      body: Padding(
        ...
        child: Column(
          children: [
                ...
                tabs: [
                  Tab(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(8)),
                      child: const Center(child: Text('Personal',style: TextStyle(
                  ...
                  Tab(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        // color: Colors.blue,
                          borderRadius: BorderRadius.circular(8)),
                      child: const Center(child: Text('Professional',style: TextStyle(
                          fontWeight: FontWeight.w400
                      ))),
                    ),
                  ),
                  Tab(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        // color: Colors.blue,
                          borderRadius: BorderRadius.circular(8)),
                      child: const Center(child: Text('Documents',style: TextStyle(
                        fontWeight: FontWeight.w400
                      ),)),
                    ),
                  ),
            ...
            SizedBox(height: Get.height*0.02,),
            Expanded(
              child: TabBarView(controller: profileController.tabController, children: [
                Column(
                  children: [
